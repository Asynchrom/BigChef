<template>
  <div class="container-fluid">
    <div
      ...
      class="card btn border-secondary text-secondary bg-transparent m-3 float-left"
    ...
    <div
      v-else
      class="card text-white bg-secondary m-3 float-left"
      style="width: 18rem; height: 14rem;"
    >
      <div class="card-header">
        <span
          v-on:keydown.enter="saveCard()"
