  ...
  <div class="row" style="min-height:90vh">
    <div style="width:80%; max-width:800px; margin:2.5% auto">
      ...
      <div class="form-group">
        ...
        <textarea v-bind:disabled="disable" v-model="recipe.description" class="form-control" placeholder="Mix all ingredients together and fry them on frying pan." rows="3"></textarea>
      </div>
